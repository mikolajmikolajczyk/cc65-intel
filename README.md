...
> ⚠️ **Work in progress / early scaffold.** APIs unstable.
...
- [ ] core: parse (lezer) → struct/field/decl extraction
- [ ] core: resolver — `var → type`, `.`/`->` member completion (Tier 1)
- [ ] core: cc65 sysroot register structs (Tier 2)
- [ ] lsp: completion + hover (worker transport)
