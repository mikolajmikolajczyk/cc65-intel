...
import type { CDocumentSymbol, CDocSymbolKind } from './types.js'
import { parseC } from './parse.js'
import { declaredIds, deepChild, slice } from './ast.js'
...
export function documentSymbols(text: string): CDocumentSymbol[] {
