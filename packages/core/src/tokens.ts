...
import type { CIndex, CSemanticToken, CTokenType } from './types.js'
import { parseC } from './parse.js'
import { slice, walk } from './ast.js'
...
export function semanticTokens(index: CIndex, text: string): CSemanticToken[] {
